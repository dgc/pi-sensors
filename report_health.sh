...
/usr/bin/mosquitto_pub -q 2 -h $MQTT_HOST -t $MQTT_CHAN -m "{\"timestamp\":$TIMESTAMP,\"device\":\"$DEVICE\",\"ipv4_address\":\"$IPV4_ADDR\",\"mac_address\":\"$MAC_ADDR\",\"space\":$SPACE,\"load\":$LOAD}"
